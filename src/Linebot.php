...
use Raystech\LINEBot\Event\Parser\EventRequestParser;
use Raystech\LINEBot\HTTPClient;
use Raystech\LINEBot\MessageBuilder;
use Raystech\LINEBot\MessageBuilder\TextMessageBuilder;
use Raystech\LINEBot\Response;
use Raystech\LINEBot\SignatureValidator;
use ReflectionClass;
...
class LINEBot
{
    ...
    public function replyText($replyToken, $text, $extraTexts = null)
    {
        ...
        $ref = new ReflectionClass('Raystech\LINEBot\MessageBuilder\TextMessageBuilder');
