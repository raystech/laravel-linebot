...
use Raystech\LINEBot\LINEBot;
use Raystech\LINEBot\LINEBotSDK\HTTPClient;
use Raystech\LINEBot\LINEBotSDK\HTTPClient\CurlHTTPClient;
use Raystech\LINEBot\LINEBotSDK\MessageBuilder\TextMessageBuilder;

class LINEBotAPI extends LINEBot
{
  ...
  {
    return $this->response = $this->getProfile($userId);
  }
