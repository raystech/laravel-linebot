...
namespace Raystech\LINEBot\LINEBotSDK\Event;

use Raystech\LINEBot\LINEBotSDK\Constant\EventSourceType;
use Raystech\LINEBot\LINEBotSDK\Exception\InvalidEventSourceException;
 ...
 *
 * @package Raystech\LINEBot\LINEBotSDK\Event
 */
class BaseEvent
{
    /** @var array */
